  ...
  data() {
	return {
		Resources: [
			...
			{
				title: "Article", subTitle: "Behind the scenes of developing Pfizer's COVID-19 vaccine", src: "https://via.placeholder.com/377x276/ffe6f0?text=7", alt: "Person with face mask7"
			},
		],
		Topics: [
			{
